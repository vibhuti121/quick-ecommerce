...
RA=$(curl -fs -w '\n%{http_code}' -X POST "$ORD/checkout" \
  ...
  -d '{"currency":"INR","customerName":"Saga Tester","customerPhone":"9990000001","deliveryAddress":"1 Test Lane, Bengaluru","pincode":"560001","city":"Bengaluru","state":"Karnataka","items":[{"productId":1,"sku":"WIDGET-A","name":"Widget A","unitPrice":100.00,"quantity":2}]}')
...
RC=$(curl -fs -X POST "$ORD/checkout" \
  ...
  -d '{"currency":"INR","customerName":"Saga Tester","customerPhone":"9990000001","deliveryAddress":"1 Test Lane, Bengaluru","pincode":"560001","city":"Bengaluru","state":"Karnataka","items":[{"productId":3,"sku":"WIDGET-C","name":"Widget C","unitPrice":100.66,"quantity":1}]}')
...
RD=$(curl -fs -X POST "$ORD/checkout" \
  ...
  -d '{"currency":"INR","customerName":"Saga Tester","customerPhone":"9990000001","deliveryAddress":"1 Test Lane, Bengaluru","pincode":"560001","city":"Bengaluru","state":"Karnataka","items":[{"productId":4,"sku":"WIDGET-D","name":"Widget D","unitPrice":10.00,"quantity":100}]}')
